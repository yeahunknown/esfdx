...
interface TokenCreatorProps {
  onAddLiquidity?: (tokenData: { address: string; name: string; symbol: string; supply: string }) => void
  defaultValues?: Partial<FormValues>
}

export function TokenCreator({ onAddLiquidity, defaultValues }: TokenCreatorProps) {
  ...
  return (
    <div className="mt-6 space-y-6">
      <div className="relative">
        ...
        <Card className="border-[#ccbe43]/20 bg-[#0e0e0e] backdrop-blur-sm shadow-[0_0_40px_hsl(var(--primary)/0.1)]">
          <CardContent className="pt-6">
            {isCreated ? (
              ...
              >
                <motion.div
                  className="w-20 h-20 rounded-full bg-gradient-to-r from-[#ccbe43] to-white/30 flex items-center justify-center"
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
                ...
                <motion.div
                  className="bg-[#0e0e0e] p-6 rounded-lg w-full max-w-md border border-[#ccbe43]/30"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  <div className="flex justify-between mb-4 items-center">
                    ...
                    <span className="font-mono text-[#ccbe43] flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="ml-1 p-1 rounded hover:bg-[#ccbe43]/10"
                        title="Copy address"
                      >
                        <Copy className="w-4 h-4 text-[#ccbe43]" />
                      </button>
                ...
                <div className="flex gap-4 mt-4">
                  ...
                  >
                    <Button variant="outline" className="border-[#ccbe43]/30 text-[#ccbe43] hover:bg-[#ccbe43]/10" onClick={() => onAddLiquidity && onAddLiquidity({ address: tokenAddress, name: form.getValues().name, symbol: form.getValues().symbol, supply: form.getValues().supply })}>
                      Add Liquidity
                    </Button>
                  </motion.div>
                  <motion.div
                  ...
                  >
                    <Button
                      ...
                      className="bg-[#ccbe43] hover:brightness-110 text-black"
                    >
                ...
                <div className="mb-8">
                  <div className="flex justify-between items-center mb-4">
                    <h2 className="text-2xl font-bold bg-gradient-to-r from-[#ccbe43] to-white/40 bg-clip-text text-transparent">
                      {step === 1 ? "Basic Info" : step === 2 ? "Details" : "Security Settings"}
                    </h2>
                    <div className="flex items-center gap-2 text-sm text-gray-400">
                      <div className={`w-3 h-3 rounded-full ${step >= 1 ? "bg-[#ccbe43]" : "bg-gray-700"}`}></div>
                      <div className={`w-3 h-3 rounded-full ${step >= 2 ? "bg-[#ccbe43]" : "bg-gray-700"}`}></div>
                      <div className={`w-3 h-3 rounded-full ${step >= 3 ? "bg-[#ccbe43]" : "bg-gray-700"}`}></div>
                    </div>
                  </div>
                  <div className="w-full h-1 bg-[#0e0e0e] rounded-full overflow-hidden">
                    <motion.div
                      className="h-full bg-gradient-to-r from-[#ccbe43] to-white/20"
                    ...
                    <AnimatePresence mode="wait">
                                ...
                                <FormItem>
                                  ...
                                  <FormControl>
                                    <Input
                                      ...
                                      {...field}
                                      className="bg-[#0e0e0e] border-[#ccbe43]/30 focus:border-[#ccbe43] transition-colors"
                                    />
                                  </FormControl>
                        ...
                        >
                          <div className="space-y-6">
                            <div className="flex items-center gap-4 mt-2">
                              <Switch checked={addMetaData} onCheckedChange={setAddMetaData} id="add-meta-data-toggle" />
                              <label htmlFor="add-meta-data-toggle" className="text-white font-medium cursor-pointer">
                                Add Meta Data (Website, Twitter, Telegram) <span className="text-[#ccbe43] font-bold">+0.1 SOL</span>
                              </label>
                            </div>
                            {addMetaData && (
                                    ...
                                    <FormItem>
                                      ...
                                      <FormControl>
                                        <Input
                                          ...
                                          {...field}
                                          lassName="bg-[#0e0e0e] border-[#ccbe43]/30 focus:border-[#ccbe43]"
                                        />
                                      </FormControl>
                                      <FormMessage />
                                    </FormItem>
                                    ...
                                    <FormItem>
                                      ...
                                      <FormControl>
                                        <Input
                                          ...
                                          {...field}
                                          className="bg-[#0e0e0e] border-[#ccbe43]/30 focus:border-[#ccbe43]"
                                        />
                                      </FormControl>
                                      <FormMessage />
                                    </FormItem>
                                ...
                                <FormItem>
                                  ...
                                  <FormControl>
                                    <Textarea
                                      ...
                                      className="resize-none bg-[#0e0e0e] border-[#ccbe43]/30 focus:border-[#ccbe43] min-h-[120px]"
                                      {...field}
                                    />
                                  </FormControl>
                            ...
                            />
                            <div className="border border-[#ccbe43]/20 rounded-lg p-6 bg-[#0e0e0e]/50">
                              <h3 className="font-medium mb-4 text-white flex items-center gap-2">
                                <Sparkles className="h-5 w-5 text-[#ccbe43]" /> Token Logo
                              </h3>
                              <div className="flex items-center justify-center border-2 border-dashed border-[#ccbe43]/20 rounded-lg p-6">
                                <div className="flex flex-col items-center gap-2">
                                  <Upload className="h-8 w-8 text-[#ccbe43]" />
                                  ...
                                  <Button
                                    ...
                                    variant="outline"
                                    size="sm"
                                    className="mt-2 border-[#ccbe43]/30 text-[#ccbe43] hover:bg-[#ccbe43]/10"
                          ...
                          <div className="flex justify-between mt-8">
                            <Button
                              ...
                              variant="outline"
                              onClick={prevStep}
                              className="border-[#ccbe43]/30 text-[#ccbe43] hover:bg-[#ccbe43]/10"
                            >
                      ...
                      {step === 3 && (
                        <motion.div
                          ...
                          transition={{ duration: 0.3 }}
                        >
                          <Alert className="bg-[#ccbe43]/10 border-[#ccbe43]/30 text-[#ccbe43] mb-6">
                            <AlertCircle className="h-4 w-4" />
                            <AlertTitle>Security Settings</AlertTitle>
                            <AlertDescription className="text-[#ccbe43]/80">
                              These settings are optional and can affect your token security and how it performs.
                            </AlertDescription>
                          </Alert>
        ...
        <div className="space-y-6">
                            <FormField
                              ...
                              name="taxFee"
                              render={({ field }) => (
                                <FormItem className="col-span-1 md:col-span-2 border border-[#ccbe43]/20 bg-[#0e0e0e]/50 p-4 rounded-lg">
                                  <FormLabel className="text-white flex items-center gap-2">
                                    <Flame className="h-4 w-4 text-orange-400" /> Blockchain Fee: {field.value}%
                                  </FormLabel>
                                  <FormControl>
                                    <Slider
                                      min={0}
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <FormField
                              ...
                              name="noRevokeFreeze"
                              render={({ field }) => (
                                <FormItem className="flex flex-row items-center justify-between rounded-lg border border-[#ccbe43]/20 bg-[#0e0e0e]/50 p-4">
                          ...
                          <div className="border border-[#ccbe43]/20 rounded-lg p-6 mt-6 bg-[#0e0e0e]/50">
                            <h3 className="font-medium mb-4 text-white flex items-center gap-2">
                            ...
                            <div className="space-y-3">
                              ...
                              <div className="border-t border-[#ccbe43]/10 pt-3 mt-3 flex justify-between items-center">
                          ...
                          <div className="flex justify-between mt-8">
                            ...
                            <Button
                              type="submit"
                              disabled={isCreating}
                              className="bg-[#ccbe43] hover:brightness-110 text-black font-bold group relative overflow-hidden"
                            >
