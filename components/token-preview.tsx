...
export function TokenPreview({ form }: { form: UseFormReturn<any> }) {
  ...
  return (
    <div className="w-full max-w-[300px]">
      ...
      <motion.div
        className="border border-[#3b3b3b] rounded-xl p-6 bg-[#111111]/60 backdrop-blur-sm"
      ...
      >
        <div className="flex items-center gap-4 mb-6">
          <motion.div
            className="w-16 h-16 rounded-full bg-gradient-to-br from-[#ccbe43]/30 to-cyan-500/30 border border-[#ccbe43]/40 flex items-center justify-center"
            initial={{ scale: 0 }}
          ...
          <div>
            ...
            <motion.div
              className="text-sm text-[#ccbe43] font-medium"
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
        ...
        <motion.div
          className="mt-6 pt-4 border-t border-[#ccbe43]/10"
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.3, delay: 0.7 }}
        >
          <div className="flex justify-center">
            <div className="px-4 py-1 bg-[#ccbe43]/20 rounded-full text-[#ccbe43] text-xs font-medium">
              Ready to launch 🚀
            </div>
          </div>
        </motion.div>
